...
@lapnlbot.on(admin_cmd(pattern=r"dl(?: |)(.*)", outgoing=True))
...
@lapnlbot.on(admin_cmd(pattern=r"uploadir (.*)", outgoing=True))
...
@lapnlbot.on(admin_cmd(pattern=r"ul (.*)", outgoing=True))
...
@lapnlbot.on(admin_cmd(pattern=r"uploadas(stream|vn|all) (.*)", outgoing=True))
