...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="magisk"))
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
