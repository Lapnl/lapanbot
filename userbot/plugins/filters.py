...
@lapnlbot.on(admin_cmd(pattern="savefilter (.*)"))
...
@lapnlbot.on(admin_cmd(pattern="listfilters"))
...
@lapnlbot.on(admin_cmd(pattern="clearfilter (.*)"))
...
@lapnlbot.on(admin_cmd(pattern="clearallfilters"))
