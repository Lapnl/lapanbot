# Ported from other Telegram UserBots for lapnlbot
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
        ...
        if query.startswith(
            ...
            buttons = [
                (custom.Button.inline(
                    ...
                    "Source", "https://github.com/Lapnl/lapnlbot"))]
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = "Please get your own Userbot from @lapnlbotHelp , and don't use mine!"
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            ...
            reply_pop_up_alert = "Please get your own userbot from @lapnlbotSupport "
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
