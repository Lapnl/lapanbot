...
# Ported by @its_Lapnl for lapnlbot
...
@lapnlbot.on(admin_cmd(pattern="app (.*)"))
...
@lapnlbot.on(admin_cmd(pattern="appr (.*)"))
...
async def apkr(e):
    ...
    try:
        ...
        app_details += "\n\n<b>Download : </b> <a href='https://t.me/lapnlbotHelp'>Request_Here by typing #request</a>"
