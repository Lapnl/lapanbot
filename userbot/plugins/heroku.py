...
@lapnlbot.on(admin_cmd(outgoing=True, pattern=r"(set|get|del) var(?: |$)(.*)(?: |$)([\s\S]*)"))
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern=r"usage(?: |$)"))
...
@lapnlbot.on(admin_cmd(pattern="info heroku"))
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern=r"logs"))
