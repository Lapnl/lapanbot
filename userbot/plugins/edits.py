# (c) @lapnlbotHelp
# By @Lapnl. Kangers keep credits xD
# All in one code.
...
# By @Lapnl. Kangers keep credits xD		
@lapnlbot.on(admin_cmd(outgoing=True, pattern="lul"))
...
async def join(e):
    ...
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        await e.edit("╱┏┓╱╱╱╭━━━╮┏┓╱╱╱╱ \n╱┃┃╱╱╱┃╭━╮┃┃┃╱╱╱╱ \n╱┃┗━━┓┃╰━╯┃┃┗━━┓╱ \n╱┗━━━┛╰━━━╯┗━━━┛╱")
# By @Lapnl. Kangers keep credits xD	
@lapnlbot.on(admin_cmd(outgoing=True, pattern="yes"))
...
async def join(e):
    ...
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        await e.edit("┈┈┈┈┈┈▕▔╲ \n┈┈┈┈┈┈┈▏▕ \n┈┈┈┈┈┈┈▏▕▂▂▂ \n▂▂▂▂▂▂╱┈▕▂▂▂▏ \n▉▉▉▉▉┈┈┈▕▂▂▂▏ \n▉▉▉▉▉┈┈┈▕▂▂▂▏ \n▔▔▔▔▔▔╲▂▕▂▂▂I")
# By @Lapnl. Kangers keep credits xD
@lapnlbot.on(admin_cmd(outgoing=True, pattern="gn"))
...
# By @Lapnl. Kangers keep credits xD
@lapnlbot.on(admin_cmd(outgoing=True, pattern="gm"))

async def join(e):

    await e.edit("｡♥｡･ﾟ♡ﾟ･｡♥｡･｡･｡･｡♥｡･｡♥｡･ﾟ♡ﾟ･\n╱╱╱╱╱╱╱╭╮╱╱╱╱╱╱╱╱╱╱╭╮\n╭━┳━┳━┳╯┃╭━━┳━┳┳┳━┳╋╋━┳┳━╮\n┃╋┃╋┃╋┃╋┃┃┃┃┃╋┃╭┫┃┃┃┃┃┃┃╋┃\n┣╮┣━┻━┻━╯╰┻┻┻━┻╯╰┻━┻┻┻━╋╮┃\n╰━╯╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━╯\n｡♥｡･ﾟ♡ﾟ･｡♥｡･｡･｡･｡♥｡･｡♥｡･ﾟ♡ﾟ･")

@lapnlbot.on(admin_cmd(outgoing=True, pattern="like"))
...
@lapnlbot.on(admin_cmd(pattern=r"plane", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@lapnlbot.on(admin_cmd(pattern=r"react (.*)", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
