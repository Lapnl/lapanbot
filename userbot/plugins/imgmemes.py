...
# Ported from CatUserBot for lapnlbot
...
@lapnlbot.on(admin_cmd(pattern="trump(?: |$)(.*)", outgoing=True))
...
@lapnlbot.on(admin_cmd(pattern="modi(?: |$)(.*)", outgoing=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@lapnlbot.on(admin_cmd(pattern="cmm(?: |$)(.*)", outgoing=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@lapnlbot.on(admin_cmd(pattern="kanna(?: |$)(.*)", outgoing=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
