...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="setgpic"))
@lapnlbot.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="promote(?: |$)(.*)"))
@lapnlbot.on(sudo_cmd(outgoing=True, pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@lapnlbot.on(sudo_cmd(outgoing=True, pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="gmute(?: |$)(.*)"))
@lapnlbot.on(sudo_cmd(outgoing=True, pattern="gmute(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@lapnlbot.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def pin(msg):
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@lapnlbot.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@lapnlbot.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
