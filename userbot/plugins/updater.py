...
# Rewritten for lapnlbot by @Lapnl

"""
This module is used for updating lapnlbot
"""
...
GIT_REPO_NAME = "lapnlbot"
UPSTREAM_REPO_URL = "https://github.com/Lapnl/lapnlbot"
...
async def upstream(ups):
    ...
    if ac_br != 'master':
        await ups.edit(
            ...
            'Please checkout the official branch of lapnlbot`')
        repo.__del__()
        return
